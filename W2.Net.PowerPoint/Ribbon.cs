...
namespace W2.Net.PowerPoint
{
    public partial class Ribbon
    {
        ...
        {
            String name = Path.GetFileNameWithoutExtension(Globals.ThisAddIn.Application.ActivePresentation.Name);
            ...
            Globals.ThisAddIn.Application.ActivePresentation.SaveAs(path);
